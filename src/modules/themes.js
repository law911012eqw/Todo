...
const COG = (() => {
    const settings =
        manage.elWithClasses('', 'settings-container', '', 'div');
    const settingsTab =
        manage.elWithClasses('', 'settings-tab', '', 'div');
    const tabs =
        manage.elWithClasses('', 'settings-tabs', '', 'div');
    const settingsMain =
        manage.elWithClasses('', 'settings-content', '', 'div');

    //themes content
    const themesCont =
        manage.elWithClasses('', 'themes-container', '', 'form');
    const themesSelectionPara =
        manage.createPara('Select theme:', 'lbl-theme');
    const theme_red =
        manage.createRadio('thred', 'theme-red', 'themes');
    const lbl_red =
        manage.createLabel('red', '', 'lbl-red', 'lbl-colors');
    const theme_blue =
        manage.createRadio('thblue', 'theme-blue', 'themes');
    const lbl_blue =
        manage.createLabel('blue', '', 'lbl-blue', 'lbl-colors');
    const theme_green =
        manage.createRadio('thgreen', 'theme-green', 'themes');
    const lbl_green =
        manage.createLabel('green', '', 'lbl-green', 'lbl-colors');
    const theme_yellow =
        manage.createRadio('thyellow', 'theme-yellow', 'themes');
    const lbl_yellow =
        manage.createLabel('yellow', '', 'lbl-yellow', 'lbl-colors');
    const btnThemes =
        manage.elWithClasses('', '', 'btn-tabs', 'div');
    const btnClearData =
        manage.elWithClasses('Clear Local Data', 'clear-data', '', 'button');
    const btnData =
        manage.elWithClasses('', '', 'btn-tabs', 'div');
    const settingsBtnCont =
        manage.elWithClasses('', 'settings-btns', '', 'div');

    const btnApply =
        manage.createSubmit('Apply');
    const btnClose =
        manage.elWithClasses('Close', 'settings-close', '', 'button');
    return {
        settings, settingsTab, settingsMain,
        settingsBtnCont, themesCont, btnClearData,
        btnThemes, btnData, tabs,
        themesSelectionPara,
        theme_red, lbl_red,
        theme_blue, lbl_blue,
        theme_green, lbl_green,
        theme_yellow, lbl_yellow,
        btnApply, btnClose
